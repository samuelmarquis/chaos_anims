...
def animate(iterators, flows, sflows):
    ...
    bflows = sflows["b"]
    # Camera:
    iterators[0].blocky_mp = (8 - iflows.rms*8) + (4-vflows.rms * 4)
    # Iterator 1:
    ...
    iterators[1].offset = pol2car(1 - iflows.rms, iflows.colorwheel)
    # Iterator 2:
    ...
    iterators[3].vibration2_am = cflows.rms * 4
